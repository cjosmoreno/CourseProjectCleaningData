The variables come from the accelerometer and gyroscope 3-axial raw signals tAcc-XYZ and tGyro-XYZ. This data was provided 
in Coursera.
This variables has a lot of statistics measures like: means, standard deviation, max, min, curtosis, etc
The firts transformation, in order to clean the data, was to merge both training and test data set
